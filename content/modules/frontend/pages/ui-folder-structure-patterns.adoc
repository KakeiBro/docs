...
should constantly be giving cues to the developers about the _Domain_ of the software. 
...
This obviously has to be architected with intent, and not just following a set of rules like _dogma_, 
